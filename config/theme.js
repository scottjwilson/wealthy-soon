...
export const theme = {
  ...
  fontFamily: {
    ...
    // eslint-disable-next-line
    heading: `Manrope, Roboto, Quattrocento, Open Sans, -apple-system, BlinkMacSystemFont, Helvetica, Arial, sans-serif, 'Apple Color Emoji', 'Segoe UI Emoji', 'Segoe UI Symbol'`,
  },
  layout: {
    article: "46rem",
    base: "70rem",
