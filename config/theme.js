...
//   leftToRight: `linear-gradient(-45deg, ${colors.black.blue} 0%, ${colors.black.blue} 100%)`,
//   // eslint-disable-next-line
...
export const theme = {
  ...
  fontFamily: {
    ...
    // eslint-disable-next-line
    heading: `Roboto, Quattrocento, Open Sans, -apple-system, BlinkMacSystemFont, 'Segoe UI', Helvetica, Arial, sans-serif, 'Apple Color Emoji', 'Segoe UI Emoji', 'Segoe UI Symbol'`,
  },
  layout: {
    article: "46rem",
    base: "70rem",
